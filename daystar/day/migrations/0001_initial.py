# Generated by Django 4.2.11 on 2024-04-25 07:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_of_the_person_that_has_taken_a_child', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item_name', models.CharField(blank=True, choices=[('Diapers', 'Diapers'), ('Fruits', 'Fruits'), ('Milk', 'Milk'), ('Others', 'Others')], max_length=200, null=True)),
                ('Quantity', models.IntegerField(default=0)),
                ('price', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level_of_education', models.CharField(blank=True, choices=[('diploma', 'Diploma'), ('highschool', 'Highschool'), ('others', 'Others')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doll', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='day.doll')),
        ...
        migrations.AddField(
            ...
            name='c_stay',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='day.categorystay'),
        ),
    ]
